...
module SystemdMon::Notifiers
  class Ding < Base
    ...
    def notify_start!(hostname)
      DingBot.send_markdown("### Systemd Mon Message","SystemdMon is starting on #{hostname}")
    end

    def notify_stop!(hostname)
      DingBot.send_markdown("### Systemd Mon Message","SystemdMon is stopping on #{hostname}")
    end
    ...
    def notify!(notification)
      ...
      DingBot.send_markdown("### Process Message",message)
